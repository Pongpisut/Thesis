  ...
  <body>
    ...
    <?php
      ...
      if(isset($_POST['book_edit'])){
        ...
        $qrybtn_bookp1 = $dbHandle->query("UPDATE book_t set  book_namevideo='$book_namevideo',book_videoyt='$book_videoyt',book_description='$book_description' WHERE id=$id");
        if($qrybtn_bookp1){
        ...
        <div class="box_edit">
          ...
          <div class="row">
            <div class="col-md-4">
              ...
              <input type="text" class="form-control inputbook-namevideo" name="book_namevideo" maxlength="38" autocomplete="off" placeholder="กรุณากรอกชื่อบทความวิดีโอ" required 
              value="<?=$bookedit['book_namevideo'];?>">
              <br/>
              <p class="nameform">ลิ้งค์วิดีโอ Youtube</p>
              <input type="text" class="form-control inputbook-desvideo" name="book_videoyt" autocomplete="off" placeholder="กรุณากรอกลิ้งค์วิดีโอยูทูป" required 
              value="<?=$bookedit['book_videoyt'];?>">
              <br/>
              <p class="nameform">คำอธิบายบทความสั้นๆ</p>
              <input type="text" class="form-control inputbook-desvideo" name="book_description" autocomplete="off" placeholder="กรุณากรอกคำอธิบายบทความสั้นๆ" required 
