<?php
  ...
  $perpage = 9;
    if (isset($_GET['page'])) {
      ...
      $sql_gallery = mysqli_query($dbHandle, $sql);
            ...
            <div class="box-gallery">
              <div class="headerbox-gallery">
                <img
                  ...
                  alt=""
                />
                <span class="name-sub">รูปภาพกิจกรรม</span>
              </div>
              <hr style="margin-top: -.5em;" />
              <center>
                <div class="row">
                <?php while($sql_cat = $sql_gallery->fetch_assoc()) {?>
                  <div class="col-md-4">
                    <div class="galley-show">
                      <figure class="hovergalleryshow">
                        <div class="photos-gallery">
                          <img
                            src="assets/img/cover/<?=$sql_cat['gallery_cover'];?>"
                            class="img-fluid img-covergallery"
                            alt=""
                          />
                          <p>
                            <span class="namegallerybox"
                              ><?=$sql_cat['catalog_gallery'];?> </span
                            ><br /><?php
                                $datetime =  $sql_cat['date_gallery'];
                                echo thai_date_and_time(strtotime($datetime));
                            ?><br />

                            <a href="gallery_show.php?id=<?=$sql_cat['id'];?>"
                              ><button class="btn btn-danger opengalleryshow" id="<?=$sql_cat['id'];?>">
                ...
                <nav aria-label="...">
                  <ul class="pagination pagination-md">
                    ...
                    <li class="page-item <?php if($page==$i) echo 'active';?>">
                      <a class="page-link" href="gallery.php?page=<?=$i?>"><?php echo $i;?></a>
                    </li>
                    <?php } ?>
                  </ul>
                </nav>
